                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            ...
                                            <div class="media">
                                                ...
                                                <img class="testimonial-author-img ml-3" src="{{asset('assetss')}}/admin/images/avatar/1.png" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img width="35" src="{{asset('assetss')}}/admin/images/avatar/1.png" alt=""></a>
                                            </div>
                                        </td>
                                        <td>Lew Shawon</td>
